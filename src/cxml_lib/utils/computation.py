...
from cxml_lib.logger import Paths, logger
from cxml_lib.utils.json import convert_to_json_compatible, safe_json_dump
...
def compute(pyfile: str, args: dict | str):
    try:
        ...
        with warnings.catch_warnings(record=True) as warnings_list:
            pyfunction = import_module(f"cxml_lib.{pyfile}")
